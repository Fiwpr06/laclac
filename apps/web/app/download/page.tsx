...
export default function DownloadPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] w-full flex flex-col pt-12 pb-24 relative overflow-hidden bg-brand-background">
      {/* Background decoration - Light Mode */}
      <div className="absolute top-0 inset-x-0 h-screen bg-gradient-to-b from-brand-primary/5 via-transparent to-transparent -z-10" />
      <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-brand-primary/10 rounded-full blur-[100px] -z-10" />
      ...
      <div className="max-w-6xl mx-auto w-full px-6 lg:px-8 flex flex-col lg:flex-row gap-16 lg:gap-24 items-center justify-between relative z-10">
        ...
        <div className="flex-1 w-full flex flex-col items-center lg:items-start order-2 lg:order-1 mt-8 lg:mt-0">
          <div className="space-y-6 text-center lg:text-left max-w-xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-primary/10 text-brand-primary font-medium text-sm">
              <span className="w-2 h-2 rounded-full bg-brand-primary animate-pulse" />
              Phiên bản mới nhất
            </div>
            
            <h1 className="text-5xl md:text-6xl font-heading font-extrabold text-brand-secondary tracking-tight leading-tight">
